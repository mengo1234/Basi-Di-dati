...
<body>
  ...
  <label for="tipologiaSondaggio">Scegli la tipologia:</label>
  <select id="tipologiaSondaggio">
    <option value="tipologia1">Tipologia 1</option>
    <option value="tipologia2">Tipologia 2</option>
    <option value="tipologia3">Tipologia 3</option>
  </select>
