...
<body>
  ...
  <div id="domandaApertaForm" style="display: none;">
    ...
    <form method="POST" action="C:\Users\Administrator\Desktop\Basi-Di-dati\PHP\InserimentoDomandaAperta.php">
        <!-- Menù di selezione -->
  ...
  <div id="domandaChiusaForm" style="display: none;">
    ...
    <form method="POST" action="C:\Users\Administrator\Desktop\Basi-Di-dati\PHP\InserimentoDomandaChiusa.php">
        <!-- Menù di selezione -->
    <label for="tipoSondaggio">Tipologia Sondaggio:</label>
    <select id="tipoSondaggio">
      <option value="opzione1">Parola chiave 1 + Codice 1</option>
