...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Bind dei parametri
    $stmt->bind_param("siss", $testo, $punteggio, $foto, $risposta); /*i ed s sono gli specificatori dei parametri e si riferiscono alle tipologie di parametro in input che seguono se intero o stringa*/ 
